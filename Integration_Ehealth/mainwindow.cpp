    ...
    , ui(new Ui::MainWindow)
{
    ...
    QObject::connect(A.getserial(),SIGNAL(readyRead()),this,SLOT(update_label_aziz()));
...
void MainWindow::on_english_clicked()
{
    ...
    if (ui->english->isChecked())
    {
        ...
        translator->load("C:\\Users\\khali\\Desktop\\backup\\backup eya\\E-Health_2A1\\Integration_Ehealth\\english.qm");
